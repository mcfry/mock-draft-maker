...
function NotFound() {
  return (
    <main className="flex flex-col grow items-center justify-center space-y-4 text-gray-900 bg-gradient-to-t from-base-100 via-base-300 to-gray-300 dark:from-gray-500 dark:to-gray-100 dark:text-gray-900">
