...
function DefensiveAnalysis({ playerInAnalysis, defStats }) {
  ...
  return (
    <div className="flex flex-col justify-evenly h-[24.25rem]">
      {defStats && Object.keys(defStats).length === 0 ? (
                  ...
                  defStats && [
                    ...
                    },
                    {
                      ...
                      [playerInAnalysis.last]:
                        playerInAnalysis.defense.assisted,
                    ...
                    },
                    {
                      name: "Sck Yds",
                      [playerInAnalysis.last]:
                        playerInAnalysis.defense.sack_yards,
                ...
                data={
                  defStats && [
                    ...
                    },
                    {
                      name: "Int Yds",
                      [playerInAnalysis.last]:
                        playerInAnalysis.defense.int_yards,
                      "Top 20": defStats.top_20_int_yards
                    },
                    {
                      name: "Int Lng",
                      [playerInAnalysis.last]:
                        playerInAnalysis.defense.int_long,
                      "Top 20": defStats.top_20_int_long
                    },
                    {
                      name: "Tds",
                      [playerInAnalysis.last]:
                        playerInAnalysis.defense.touchdowns,
